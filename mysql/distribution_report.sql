...
from mc_distribution as md inner join
mcart_customers as mc on md.mccsid=mc.mccsid inner join
mcart_subscriptions as ms on ms.mccsid=mc.mccsid inner join
mc_distributors as mds on md.mcdid=mds.id inner join
mc_delivery_boys mdb on md.mcdbid=mdb.id inner join
